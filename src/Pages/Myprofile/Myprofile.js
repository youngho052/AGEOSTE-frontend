...
import { SERVER_ACCOUNT, SERVER_AUTH } from "../../config/Server";
...
const INFORMATION = [
  {
    name: "내 라코스테 부티크",
    content: "자주 찾는 부티크를 추가해주세요",
    link: "+부티크 추가하기",
  },
  {
    name: "주소록",
    content: "알려진 주소가 없습니다",
    link: "+새로운 주소 추가하기",
  },
];
          ...
          <div className="profile">
            <div className="intro">
              <div className="welcome">
                <p>
                  <span>안녕하세요 {userInfo.name}</span> 님 마이페이지에 오신
                  것을 환영합니다.
                </p>
              </div>
              <div className="logo">
                ...
                <div className="info">
                  ...
                  <div className="auth">
                    <div className="myAuth">
                      ...
                      <span
                        className={`authEmail ${userInfo.is_active && "true"}`}
                      >
                        {userInfo.is_active
                          ? "인증완료"
                          : "인증되지 않은 메일입니다."}
                    ...
                    <button onClick={this.authHandle}>인증받기</button>
                  </div>
